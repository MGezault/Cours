...
def test_get_nb_colonne():
    m1 = matrice1()
    m2 = matrice2()
    m3 = matrice3()
    assert matrice.get_nb_colonne(m1) == 4
    assert matrice.get_nb_colonns(m2) == 3
    assert matrice.get_nb_colonne(m3) == 3
